      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?= base_url('pengguna/tambahRekamMedis'); ?>">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" action="<?= base_url('dashboard/index') ?>" action="GET">
            <div class="input-group">
              <input id="search_header" value="<?= (!empty($search_header)) ? $search_header : '' ?>" type="text" required class="form-control bg-light border-0 small" placeholder="Cari Nama atau Nomor RM" aria-label="Search" aria-describedby="basic-addon2">
